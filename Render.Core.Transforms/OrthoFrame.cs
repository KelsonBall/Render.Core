...
namespace Render.Core.Transforms
{
    ...
    /// </summary>
    public class OrthoFrame : Transform<Vector3>
    {
        ...
        public Rektor Scale
        {
            ...
            set
            {
                ...
                scaleTransform = Transform3.Scale(new Vector3(value.X, value.Y, 1));
                Calculate();
            }
        }
        ...
        {
            Scale = new Vector3(Scale.X * s.X, 1, Scale.Y * s.Y).ToVector();
            return this;
        }
        ...
        public double Rotation
        {
            ...
            set
            {
                ...
                var stack = Transform3.NewTransformStack();
                stack.Push(Transform3.Rotation(value, Vector3.k̂));
