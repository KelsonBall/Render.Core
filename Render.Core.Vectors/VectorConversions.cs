...
namespace Render.Core.Vectors
{
    public static class VectorConversions
    {
        ...
        public static v ToMathVector(this Rektor3 vector) => GetMathVector(vector.X, vector.Y, vector.Z);

        public static v ToMathVector(this Rektor vector) => GetMathVector(vector.X, vector.Y);

        public static Rektor3 ToRVector3(this v source) => new Rektor3((float)source[0], (float)source[1], (float)source[2]);
